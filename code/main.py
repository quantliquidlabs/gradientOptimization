...
x_best, y_best = gopt.gradient_descent(0.0001, 1, 1000)
...
torch.manual_seed(0)
x_best, y_best = gopt.perturbed_gradient_descent(0.0001, 1, 1000, 1000)
...
torch.manual_seed(0)
x_best, y_best = gopt.modified_gradient_descent(0.0001, 1, 1000, 1000, 10)
